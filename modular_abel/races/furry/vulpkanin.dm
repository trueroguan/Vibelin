...
/datum/species/vulpkanin
	...
	desc = "A subspecies of the more common Lupian, found almost exclusively in thick forests. \
	...
	statsheet_male = /datum/attribute_holder/sheet/job/species/vulpkanin
	...
	organs = list(
		...
		ORGAN_SLOT_EARS = /obj/item/organ/ears/anthro/fox,
