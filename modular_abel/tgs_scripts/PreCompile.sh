...
# compile tgui and inject modular build state for TGS compile
echo "Compiling tgui and preparing modular Abel..."
cd "$1"
env TG_BOOTSTRAP_CACHE="$original_dir" CBT_BUILD_MODE="TGS" modular_abel/build.sh tgs
