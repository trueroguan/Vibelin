...
/obj/item/weapon/sword/long/broadsword/bronze/apophis
	name = "apophis"
	desc = "A heavy bronze greatblade, wide enough to cleave through both flesh and pretense. Named for the serpent that swallows the sun."
...
/obj/item/weapon/katar/bronze/gladiator
	name = "arbelos"
