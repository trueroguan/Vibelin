...
/datum/component/riding/proc/restore_rider_layer_and_offsets(mob/living/buckled_mob)
	...
	if(buckled_mob.body_position == LYING_DOWN) // EXPERIMENTAL: Restore body position offsets after unbuckle
		buckled_mob.on_lying_down()
...
/datum/component/riding/proc/driver_move(atom/movable/movable_parent, mob/living/user, direction, actual_move_delay)
	SIGNAL_HANDLER
	SHOULD_CALL_PARENT(TRUE)
	movable_parent.set_glide_size(DELAY_TO_GLIDE_SIZE(actual_move_delay || vehicle_move_delay))
